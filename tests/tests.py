...
class MyTestCase(unittest.TestCase):
    ...
    def test_creating_temp_folder(self):
        self.assertTrue(os.path.isdir(test_backend.working_dir))

    def test_accelerate(self):
        test_backend.accelerate('test.mp3', 3)
        time.sleep(1)
        output = pathlib.Path(test_backend.working_dir, 'test_accelerated_by_3.mp3')
    ...
    def test_cut(self):
        ...
        time.sleep(1)
        output = pathlib.Path(test_backend.working_dir, 'test_cut.mp3')
    ...
    def test_reverse(self):
        ...
        time.sleep(1)
        output = pathlib.Path(test_backend.working_dir, 'test_reversed.mp3')
    ...
    def test_change_volume(self):
        ...
        time.sleep(1)
        output = pathlib.Path(test_backend.working_dir, 'test_volume_changed_by_0.005.mp3')
    ...
    def test_concat(self):
        ...
        time.sleep(1)
        output = pathlib.Path(test_backend.working_dir, 'test+test.mp3')
